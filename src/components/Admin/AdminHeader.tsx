...
export const AdminHeader: React.FC = () => {
  const { user } = useAuth();
  const { systemAlerts, refreshData } = useAdmin();
        ...
        <div className="flex items-center space-x-4">
          <div className="relative">
            ...
            <input
              ...
              className="pl-10 pr-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent w-96"
            />
          </div>
          <Button
            variant="secondary"
